  ...
  return (
    ...
    >
      <div className="relative mb-4">
        <img src={playlist.coverUrl || 'https://lastfm.freetls.fastly.net/i/u/300x300/2a96cbd8b46e442fc41c2b86b821562f.png'} alt={playlist.title} className="w-full aspect-square rounded-lg object-cover" />
      ...
      <p className="text-gray-400 text-sm truncate">{playlist.description || `${playlist.songs?.length || 0} songs`}</p>
    </div>
  );
};
